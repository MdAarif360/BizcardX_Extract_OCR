...
tab = Image.open("home.png")
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By Aarif",
                   page_icon= tab,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Aarif*!"""})
...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background: url("https://c4.wallpaperflare.com/wallpaper/52/613/66/pastel-colorful-minimalism-windows-10-vysakhjanan-hd-wallpaper-preview.jpg");
